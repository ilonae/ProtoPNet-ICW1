...
def vgg11_features(weights='DEFAULT', **kwargs):
    """VGG 11-layer model (configuration "A")

    Args:
        weights: 'DEFAULT' for ImageNet pre-trained weights, None for random init
    """
...
def vgg11_bn_features(weights='DEFAULT', **kwargs):
...
def vgg13_features(weights='DEFAULT', **kwargs):
...
def vgg13_bn_features(weights='DEFAULT', **kwargs):
...
def vgg16_features(weights='DEFAULT', **kwargs):
...
def vgg16_bn_features(weights='DEFAULT', **kwargs):
...
def vgg19_features(weights='DEFAULT', **kwargs):
...
def vgg19_bn_features(weights='DEFAULT', **kwargs):
...
if __name__ == '__main__':
    ...
    vgg11_f = vgg11_features(weights='DEFAULT')
    print(vgg11_f)

    vgg11_bn_f = vgg11_bn_features(weights='DEFAULT')
    print(vgg11_bn_f)

    vgg13_f = vgg13_features(weights='DEFAULT')
    print(vgg13_f)

    vgg13_bn_f = vgg13_bn_features(weights='DEFAULT')
    print(vgg13_bn_f)

    vgg16_f = vgg16_features(weights='DEFAULT')
    print(vgg16_f)

    vgg16_bn_f = vgg16_bn_features(weights='DEFAULT')
    print(vgg16_bn_f)

    vgg19_f = vgg19_features(weights='DEFAULT')
    print(vgg19_f)

    vgg19_bn_f = vgg19_bn_features(weights='DEFAULT')
    print(vgg19_bn_f)
