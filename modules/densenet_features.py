...
def densenet121_features(weights='DEFAULT', **kwargs):
...
def densenet169_features(weights='DEFAULT', **kwargs):
...
def densenet201_features(weights='DEFAULT', **kwargs):
...
def densenet161_features(weights='DEFAULT', **kwargs):
...
if __name__ == '__main__':
    ...
    d161 = densenet161_features(weights='DEFAULT')
    print(d161)

    d201 = densenet201_features(weights='DEFAULT')
    print(d201)

    d169 = densenet169_features(weights='DEFAULT')
    print(d169)

    d121 = densenet121_features(weights='DEFAULT')
    print(d121)
