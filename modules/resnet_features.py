...
def resnet18_features(weights='DEFAULT', **kwargs):
...
def resnet34_features(weights='DEFAULT', **kwargs):
...
def resnet50_features(weights='DEFAULT', **kwargs):
...
def resnet101_features(weights='DEFAULT', **kwargs):
...
def resnet152_features(weights='DEFAULT', **kwargs):
...
if __name__ == '__main__':
    ...
    r18_features = resnet18_features(weights='DEFAULT')
    print(r18_features)

    r34_features = resnet34_features(weights='DEFAULT')
    print(r34_features)

    r50_features = resnet50_features(weights='DEFAULT')
    print(r50_features)

    r101_features = resnet101_features(weights='DEFAULT')
    print(r101_features)

    r152_features = resnet152_features(weights='DEFAULT')
    print(r152_features)
